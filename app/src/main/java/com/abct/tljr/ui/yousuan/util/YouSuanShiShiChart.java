...
public class YouSuanShiShiChart implements Serializable{
    ...
    public YouSuanShiShiChart(LineChart quanyiquxian,String key){
    ...
    public YouSuanShiShiChart(LineChart quanyiquxian,String key,List<QiYuXianModel> listModel){
        this.quanyiquxian=quanyiquxian;
        this.key=key;
        initLineChart();
