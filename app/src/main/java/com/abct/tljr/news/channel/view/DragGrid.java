...
import com.abct.tljr.news.channel.tools.DataTools;
...
public class DragGrid extends GridView {
	...
	public void setEditText(TextView tv){
		this.tv_edit =tv ;
	}
...
//		LogUtil.i("channel ", "position"+mPosition);
//		System.out.println("position"+mPosition);
			...
			int mPosition = pointToPosition(x, y);
			...
			case MotionEvent.ACTION_DOWN:
				...
				if(mPosition != AdapterView.INVALID_POSITION){
					startPosition = mPosition;// 第一次点击的postion
					dragPosition = mPosition;
					
					  dragViewGroup = (ViewGroup) getChildAt(dragPosition - getFirstVisiblePosition());
					  dragTextView = (TextView)dragViewGroup.findViewById(R.id.text_item);
					...
					dragViewGroup.setDrawingCacheEnabled(true);
					  dragBitmap = Bitmap.createBitmap(dragViewGroup.getDrawingCache());
					  aTag=false;
				}
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (  mPosition != AdapterView.INVALID_POSITION &&isEditingMode) {
...
//				}
			...
			//	return false;
				...
				if (dragImageView != null && dragPosition != AdapterView.INVALID_POSITION &&isEditingMode) {
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				 ...
				 isEditingMode =true;
				 tv_edit.setText(isEditingMode?"完成":"编辑");
