...
import com.abct.tljr.ui.widget.XFooterView;
import com.abct.tljr.ui.widget.XHeaderView;
...
public class XScrollView extends ScrollView implements OnScrollListener {
	...
	private OnSrcollViewListener onSrcollViewListener;
...
//			 mLayout.findViewById(R.id.content_layout);
	...
	private boolean isTop() {
		return getScrollY() <= 0 || mHeader.getVisibleHeight() > mHeaderHeight
				|| mContentLayout.getTop() > 0 ||mHeader.getVisibleHeight()>0;
	}
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if(onSrcollViewListener!=null){
			onSrcollViewListener.onSrcoll(t);
		}
	...
	public interface OnSrcollViewListener{
		public void onSrcoll(int srcollY);
	}
	
	public void setOnSrcollViewListener(OnSrcollViewListener onSrcollListener){
		onSrcollViewListener=onSrcollListener;
	}
