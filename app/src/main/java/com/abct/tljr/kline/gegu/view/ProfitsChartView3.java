 ...
 */
public class ProfitsChartView3 {
	private CombinedChart combinedChart;
	private BarChart barChart;
	private CombinedData combinedData;
	private BarData barData;
	private boolean   flat;
	private boolean baifenFlat;
	private int textColor = Color.rgb(0x9a, 0x9a, 0x9a);

	public ProfitsChartView3(CombinedChart combinedChart, BarChart barChart, CombinedData combinedData,
			BarData barData,boolean  flat,boolean baifenFlat) {
		this.combinedChart = combinedChart;
		this.barChart = barChart;
		this.combinedData = combinedData;
		this.barData = barData;
		this.flat=flat;
		this.baifenFlat=baifenFlat;
	}
