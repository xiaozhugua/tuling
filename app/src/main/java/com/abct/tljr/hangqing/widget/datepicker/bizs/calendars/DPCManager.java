package com.abct.tljr.hangqing.widget.datepicker.bizs.calendars;
...
public final class DPCManager {
    private static final HashMap<Integer, HashMap<Integer, DPInfo[][]>> DATE_CACHE = new HashMap<Integer, HashMap<Integer, DPInfo[][]>>();
    ...
    public DPInfo[][] obtainDPInfo(int year, int month) {
        ...
        if (null == dataOfYear) dataOfYear = new HashMap<Integer, DPInfo[][]>();
